      ...
      <div className="max-w-3xl mx-auto px-4 md:px-8 prose-lg">
        ...
        <ScrollReveal>
          <div className="border-4 border-red-600 bg-red-50 p-5 sm:p-6 md:p-8 mb-12 md:mb-20 text-center shadow-[6px_6px_0_0_#dc2626] md:shadow-[8px_8px_0_0_#dc2626] rounded-sm relative md:-rotate-1">
            ...
            <p className="text-red-950 font-bold m-0 text-sm sm:text-base md:text-xl leading-loose">
        ...
        <ScrollReveal delay={0.3}>
          <div className="bg-[#111110] text-[#fafaf8] p-8 sm:p-10 md:p-14 text-center border-b-[8px] md:border-b-[12px] border-[#cf5230] mb-12 md:mb-16 md:rotate-1">
            ...
            <p className="text-base sm:text-lg md:text-xl text-gray-300 font-medium max-w-2xl mx-auto leading-loose">
        ...
        <ScrollReveal delay={0.4}>
          ...
          <p className="text-base md:text-xl font-medium leading-loose text-foreground mb-8 text-center max-w-2xl mx-auto">
          ...
          <div className="p-6 sm:p-8 md:p-12 border-4 border-black bg-white shadow-[8px_8px_0_0_#cf5230] md:shadow-[12px_12px_0_0_#cf5230] mb-8 text-center relative overflow-hidden">
            ...
            <p className="text-base md:text-xl font-medium text-gray-800 leading-loose max-w-2xl mx-auto mb-8 md:mb-10">
