      ...
      <div className="max-w-3xl mx-auto px-4 md:px-8 prose-lg">
        ...
        <ScrollReveal delay={0.1}>
          ...
          <div className="my-8 md:my-10 text-center">
            <p className="text-base sm:text-lg md:text-2xl leading-snug text-foreground mx-auto font-black bg-[#E54D2E] text-white p-3 inline-block md:-rotate-1 shadow-[4px_4px_0_0_#000]">
        ...
        <ScrollReveal delay={0.2}>
          ...
          <p className="text-xl sm:text-2xl md:text-3xl font-black leading-snug text-[#E54D2E] my-8 md:my-10 text-center uppercase tracking-tight">
        ...
        <ScrollReveal delay={0.4}>
          ...
          <div className="p-6 sm:p-8 md:p-12 border-4 border-black bg-white shadow-[8px_8px_0_0_#E54D2E] md:shadow-[12px_12px_0_0_#E54D2E] mb-8 text-center relative overflow-hidden">
            ...
            <h3 className="text-3xl sm:text-4xl md:text-6xl font-black text-[#E54D2E] uppercase mb-6 md:mb-8 tracking-tight md:tracking-tighter leading-[1.05]">We start with your offer.</h3>
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.96 }}
              className="inline-block w-full sm:w-auto bg-[#140E0E] text-white font-black text-base sm:text-lg md:text-2xl px-6 sm:px-10 py-4 md:py-6 uppercase tracking-wider hover:bg-[#E54D2E] transition-colors shadow-[0_6px_0_0_#E54D2E] hover:shadow-none hover:translate-y-[6px]"
            >
