    ...
    <section className={cn('py-8 md:py-14 bg-background overflow-x-hidden', className)}>
      <div className="max-w-4xl mx-auto px-4 md:px-8 prose-xl">
        ...
        <ScrollReveal delay={0.2}>
          <h2 className="text-4xl sm:text-5xl md:text-6xl font-black text-foreground mt-4 mb-4 tracking-tight md:tracking-tighter uppercase leading-[1.3] sm:leading-[1.3] md:leading-[1.3]">
        ...
        <ScrollReveal delay={0.4}>
          <div className="flex flex-col items-center justify-center mb-8 md:mb-10">
             ...
             <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-foreground mb-4 md:mb-6 uppercase tracking-tight text-center leading-[1.3] sm:leading-[1.3] md:leading-[1.3]">
