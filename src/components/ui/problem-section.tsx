      ...
      <div className="max-w-4xl mx-auto px-4 md:px-8">
        ...
        <ScrollReveal>
          <div className="mb-12 md:mb-20 text-center">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black text-foreground mb-6 uppercase tracking-tight md:tracking-tighter leading-[1.1] inline-block pb-2 border-b-4 md:border-b-8 border-[#E54D2E]">
        ...
        <ScrollReveal delay={0.1}>
          <div className="prose-xl mx-auto text-center md:text-left">
            <p className="text-base sm:text-lg md:text-xl font-medium text-foreground leading-relaxed mb-8 md:mb-10">
            ...
            <p className="text-sm sm:text-base font-bold text-foreground leading-relaxed text-center max-w-4xl mx-auto mb-12 md:mb-20 italic bg-white p-4 sm:p-6 md:p-8 pt-10 sm:pt-8 border-2 border-gray-100 shadow-sm relative">
        ...
        <ScrollReveal delay={0.2}>
          <div className="mt-10 sm:mt-16 md:mt-20 p-5 sm:p-8 md:p-12 bg-[#140E0E] text-[#fafaf8] text-center border-t-4 md:border-t-8 border-[#E54D2E] md:-rotate-1 relative shadow-2xl">
            ...
            <h3 className="text-base sm:text-lg md:text-xl font-black uppercase mb-6 md:mb-8 tracking-tight md:tracking-tighter leading-[1.2] relative z-10">
              So how do you fix something the entire industry pretends isn't broken?
            </h3>
            <h3 className="text-xl sm:text-2xl md:text-4xl lg:text-5xl font-black uppercase text-[#E54D2E] tracking-tight md:tracking-tighter relative z-10 mb-6 md:mb-8 leading-[1.1]">
              You build the other half.
            </h3>

            <p className="text-sm sm:text-base md:text-lg font-bold text-gray-400 italic mb-8 md:mb-12 relative z-10 px-2 leading-relaxed">
